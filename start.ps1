...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "`$env:PATH = '$env:PATH'; `$env:PYTHONPATH = 'D:\game\backend'; cd D:\game\backend; uvicorn app.main:app --host 127.0.0.1 --port 8000 --reload"

Start-Sleep -Seconds 2

Write-Host "Starting Frontend..." -ForegroundColor Green
Start-Process powershell -ArgumentList "-NoExit", "-Command", "`$env:PATH = '$env:PATH'; cd D:\game\frontend; npm run dev"
